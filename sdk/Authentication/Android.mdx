 ...
 **[0.1.30]**
  ...
  - [#131](https://github.com/huma-engineering/huma-android-sdk/pull/131) Fixed crash when opening Auth UI flow
  - [#133](https://github.com/huma-engineering/huma-android-sdk/pull/133) Auth update to current BE standards
