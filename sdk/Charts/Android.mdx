...
Creating intanse of `ChartContainerView` component from code:
  ```kotlin
...
**BarChartDataProcessor** - contains impelmentation of processing row input data to data type which used to dispaly items on LineChart. 
