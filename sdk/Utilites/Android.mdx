...
SDK use [OkHttp](https://square.github.io/okhttp/) and [Retrofit](https://square.github.io/retrofit/) for networking. You can use the instance of Retrofit to create your API interface. SDK allows registering your [interceptor](https://square.github.io/okhttp/interceptors/) or authenticator 
...
`PreferencesManager` exposes `baseUrlPreferencesManager` where stored actual target URL for `NetworkManager`. It contains method to obtain and store values in SharedPreferences with modifiers.
