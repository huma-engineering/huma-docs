...
# Android
Library that encapsulates integration with [Twilio](https://www.twilio.com/video) VoIP service

### Getting Started
<Tabs>
<TabItem value="example" label="Example" default>

Call Kit sdk integrates with [Twilio](https://www.twilio.com/video) VoIP service, no extra work is required to configurate it.
