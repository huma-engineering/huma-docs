...
2. Download the _HumaEnvironment.plist_ file from the Builder portal and add it to your project's app folder.
   1. Log in to the [Huma Workspace](https://workspace.huma.com/).
   2. Click [here](https://workspace-gcp-uk.api.huma.com/api/integration/v1/configs/ios) to download the `HumaEnvironment.plist`.
   3. Copy the `HumaEnvironment.plist` to your project directory.
