...
4. Download the `huma-sdk-config.json` file from the Huma workspace and add it to your project's app
   folder.
      ...
      2. Click [here](https://workspace-gcp-uk.api.huma.com/api/integration/v1/configs/android) to download the `huma-sdk-config.json`.
      3. Copy the `huma-sdk-config.json` to your project directory.
