...
<Image 
    src="https://f.hubspotusercontent30.net/hubfs/4899239/Register-2.gif"
    alt="Questionnaires"
    isBorder
    isLink
    width="85%"
...
<Image 
    src="https://info.huma.com/hubfs/CP-Microsite_Signing-in.gif"
    alt="Questionnaires"
    isBorder
    isLink
    width="85%"
...
<Image 
    src={require('./navigate_cp.gif').default}
    alt="Questionnaires"
    isLink
    width="85%"
    borderRadius="10px"
